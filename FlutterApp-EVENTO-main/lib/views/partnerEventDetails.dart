...
class PartnerEventDetailScreen extends StatefulWidget {
  const PartnerEventDetailScreen({Key? key}) : super(key: key);

  @override
  State<PartnerEventDetailScreen> createState() =>
      _PartnerEventDetailScreenState();
}
...
class _PartnerEventDetailScreenState extends State<PartnerEventDetailScreen> {
  ...
  void initState() {
    _controller.onLoad();
    _controller.prepareRating(_controller.data['PartnerCompRating']);
  ...
  Widget build(BuildContext context) {
    ...
    print("Patner Event Detail ===== ${_controller.data}");
