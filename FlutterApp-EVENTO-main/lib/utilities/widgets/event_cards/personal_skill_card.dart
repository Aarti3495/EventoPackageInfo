...
class PersonalSkillCard extends StatefulWidget {
  ...
  @override
  _PersonalSkillCardState createState() => _PersonalSkillCardState();
}

class _PersonalSkillCardState extends State<PersonalSkillCard> {
                                ...
                                children: [
                                  RatingBarIndicator(
                                    rating: CommonHelper().prepareRating(
                                        widget.data['PersonalSkillRating']),
                                ...
                                children: [
                                  FutureBuilder(
                                      future: DashboardController.dashboardFind
                                          .convertPrice(
                                  (widget.data['price']!=null)?widget.data['price'].toInt():0),
                                      initialData: "",
                              ...
                              child: Card(
                                ...
                                child: Padding(
                                  ...
                                  child: SvgPicture.asset(
                                    ...
                                    height: 13,
                                    color:
                                        widget.data['whishlist_status'] ?? false
                                            ? Colors.red
                            ...
                            GestureDetector(
                              onTap: () {
                                CommonHelper().shareOption(
                                    ...
                                    category: widget.data['pro_category'],
                                    address: widget.data['com_address'],
                                    price: widget.data['work_price'] ?? '0',
                                    eventLink: Constants().apiUrl +
                                        "personalskill_get_list/" +
                                        widget.data["perskillId"].toString());
                              },
                              child: Card(
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(50),
